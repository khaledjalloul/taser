...
class GPT(nn.Module):
    def __init__(self, config: GPTConfig):
        ...
        self.encoder = nn.ModuleDict(
            dict(
                token_embed=nn.Linear(common_token_dim, self.config.n_embd),
        ...
        self.x_encoder = nn.Linear(self.config.obs_dim, common_token_dim)
    ...
    def forward(self, x: torch.Tensor, **kwargs: Any) -> torch.Tensor:
        ...
        x_tokens = self.x_encoder(x)  # (B,token_dim)
