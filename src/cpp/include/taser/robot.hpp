...
#include "taser/arm_motion/controller.hpp"
#include "taser/arm_motion/kinematics.hpp"
#include "taser/locomotion/kinematics.hpp"
#include "taser/navigation/controller.hpp"
...
public:
  ...
  std::map<std::string, arm_motion::Kinematics> arms;
  std::unique_ptr<arm_motion::Controller> arm_controller;
