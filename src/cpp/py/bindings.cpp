...
PYBIND11_MODULE(taser_cpp, m) {
  ...
  // Arm Motion Submodule
  py::module_ arm_motion =
      m.def_submodule("arm_motion", "Logic for the robot arms");

  // Arm Motion Controller
  py::class_<arm_motion::Controller>(arm_motion, "Controller")
      .def(py::init<double>(), py::arg("kp"))
      .def("step", &arm_motion::Controller::step, py::arg("x0"),
           py::arg("x_ss"));

  // Arm Motion Kinematics
  py::class_<arm_motion::Kinematics>(arm_motion, "Kinematics")
      .def(py::init<std::string>(), py::arg("name"))
      .def("get_end_effector_pose",
           &arm_motion::Kinematics::get_end_effector_pose, py::arg("TBE"))
      .def("get_end_effector_twist",
           &arm_motion::Kinematics::get_end_effector_twist, py::arg("tfs"),
           py::arg("dq"))
      .def("solve_ik_for_joint_positions",
           &arm_motion::Kinematics::solve_ik_for_joint_positions,
           py::arg("p_desired"), py::arg("tfs"))
      .def("solve_ik_for_joint_velocities",
           &arm_motion::Kinematics::solve_ik_for_joint_velocities,
